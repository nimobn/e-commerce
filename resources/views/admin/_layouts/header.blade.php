<header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-blue-600">
    <div class="flex items-center">
        ...
        <div class="relative mx-4 lg:mx-0">
            ...
            <input class="form-input w-32 sm:w-64 rounded-md pr-10 pl-4 focus:border-indigo-600" type="text" placeholder="@lang("admin.table.search placeholder")">
        </div>
    </div>
    ...
    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="relative">
            ...
            <div x-show="notificationOpen" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10" style="width:20rem;">
                <a href="#" class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                    <img class="h-8 w-8 rounded-full object-cover mx-1" src="{{ asset('images/product/p1.jpg') }}" alt="avatar">
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            <button @click="dropdownOpen = ! dropdownOpen" class="relative block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
                <img class="h-full w-full object-cover" src="{{ asset('images/product/p1.jpg') }}" alt="Your avatar">
            </button>
